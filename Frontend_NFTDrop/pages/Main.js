    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.container}>
        <section className={styles.infoSection}>
          ...
          <Hero />
          <div>
            {candyStateLoading ? (<div>Loading</div>) : candyStateError ? (<div>{candyStateError}</div>) : (
              candyState && (
                <div>
                  ...
                  <div className={styles.buttonContainer}>
                    <button className={styles.mintButton} onClick={mint} disabled={!wallet || txLoading || soldOut}>{soldOut ? "Sold Out" : txLoading ? "Loading" : "Mint"}</button>
                  </div>
                </div>
              )
            )}
